var LangText = {
  en: {
    t1: "Welcome to NarwhalSlicer",
    t2: "NarwhalSlicer will be setup in several steps. Let's start!",
    t3: "User Agreement",
    t4: "Disagree",
    t5: "Agree",
    ...
    t65: "Please be aware that these plugins are not developed or maintained by NarwhalSlicer. They should be used at your own discretion and risk.",
    ...
    t83: "2, Close all open NarwhalSlicer",
    t84: "3, Delete all files under the plug-in directory",
    t85: "4, Reopen NarwhalSlicer and install the plug-in again",
    t86: "Close",
    t87: "User Manual",
    t88: "Remove",
  ...
  ca_ES: {
    t1: "Benvingut a NarwhalSlicer",
    t2: "NarwhalSlicer es configurarà en diversos passos. Comencem!",
    ...
    t65: "Tingues en compte que aquests connectors no són desenvolupats ni mantinguts per NarwhalSlicer. S'han d'utilitzar a la teva discreció i risc.",
    ...
    t83: "2, Tanca totes les NarwhalSlicer obertes",
    t84: "3, Elimina tots els fitxers del directori de connectors",
    t85: "4, Reobre NarwhalSlicer i instal·la el connector de nou",
    t86: "Tancar",
  ...
  es_ES: {
    t1: "Bienvenido a NarwhalSlicer",
    t2: "NarwhalSlicer se configurará mediante varios pasos. ¡Comencemos!",
    t3: "Términos de uso",
    t4: "No acepto",
    t5: "Acepto",
    ...
    t65: "Tenga en cuenta que estos complementos no están desarrollados ni mantenidos por NarwhalSlicer. Deben usarse bajo su propia responsabilidad.",
    ...
    t83: "2. Cierre todas las instancias de NarwhalSlicer",
    t84: "3. Elimine todos los archivos del directorio de complementos",
    t85: "4. Vuelva a abrir NarwhalSlicer e instale el complemento de nuevo",
    t86: "Cerrar",
  ...
  it_IT: {
    t1: "Benvenuti in NarwhalSlicer",
    t2: "NarwhalSlicer verrà configurato seguendo diversi passaggi. Cominciamo!",
    t3: "Condizioni d'uso",
    t4: "Non accetto",
    t5: "Accetto",
    ...
    t65: "Si prega di notare che questi moduli non sono sviluppati o mantenuti da NarwhalSlicer. Dovrebbero essere utilizzati a proprio rischio e discrezione.",
    ...
    t83: "2, Chiudere tutte le istanze di NarwhalSlicer",
    t84: "3, Eliminare tutti i file all'interno della directory del modulo",
    t85: "4, Riaprire NarwhalSlicer e installare nuovamente il modulo",
    t86: "Chiudi",
    t87: "Manuale d'uso",
    t88: "Rimuovi",
  ...
  de_DE: {
    t1: "Willkommen im NarwhalSlicer",
    t2: "Das NarwhalSlicer wird in mehreren Schritten eingerichtet. Lass uns anfangen!",
    ...
    t83: "2, Schließen Sie alle geöffneten NarwhalSlicer",
    t84: "3, Löschen Sie alle Dateien im Plug-in-Verzeichnis",
    t85: "4, Öffnen Sie NarwhalSlicer erneut und installieren Sie das Plug-in erneut",
    t86: "Schließen",
  ...
  cs_CZ: {
    t1: "Vítejte v NarwhalSlicer",
    t2: "NarwhalSlicer bude nastaven v několika krocích. Začněme!",
    ...
    t83: "2, Zavřete všechny otevřené NarwhalSlicer",
    t84: "3, Smažte všechny soubory v adresáři plug-in",
    t85: "4, znovu otevřete NarwhalSlicer a znovu nainstalujte zásuvný modul",
    t86: "Zavřít",
  ...
  fr_FR: {
    t1: "Bienvenue sur NarwhalSlicer",
    t2: "NarwhalSlicer sera configuré en plusieurs étapes. Commençons !",
    ...
    t65: "Veuillez noter que ces plugins ne sont pas développés ou maintenus par NarwhalSlicer. Ils doivent être utilisés à votre propre discrétion et à vos propres risques.",
    ...
    t83: "2, Fermez toutes les fenêtres de NarwhalSlicer",
    t84: "3, Supprimez tous les fichiers dans le répertoire du plug-in",
    t85: "4, Relancez NarwhalSlicer et réinstallez le plug-in.",
    t86: "Fermer",
  ...
  zh_CN: {
    t1: "欢迎使用NarwhalSlicer",
    t2: "NarwhalSlicer需要几步安装步骤，让我们开始吧！",
    t3: "用户使用协议",
    t4: "拒绝",
    t5: "同意",
    ...
    t64: "Bambu网络插件",
    t65: "注意：这些插件不是由NarwhalSlicer开发或维护的。使用它们需自担风险",
    t66: "强大的远程控制功能",
    t67: "实时视频流",
    t68: "用户数据同步",
    t69: "安装Bambu网络插件",
    ...
    t81: "1, 点击",
    t82: "打开插件所在目录",
    t83: "2, 关闭所有NarwhalSlicer",
    t84: "3, 删除插件所在目录下的所有文件",
    t85: "4, 重新启动NarwhalSlicer并尝试安装插件",
    t86: "关闭",
    t87: "使用引导",
    t88: "移除",
    t89: "打开所在的文件夹",
  ...
  zh_TW: {
    t1: "歡迎使用 NarwhalSlicer",
    t2: "NarwhalSlicer 需要幾步安裝步驟，讓我們開始吧！",
    t3: "使用者協議",
    t4: "拒絕",
    t5: "同意",
    ...
    t81: "1, 點擊",
    t82: "打開插件所在目錄",
    t83: "2, 關閉所有 NarwhalSlicer",
    t84: "3, 刪除插件所在目錄下的所有文件",
    t85: "4, 重新啟動 NarwhalSlicer 並嘗試安裝插件",
    t86: "關閉",
    t87: "使用引導",
    t88: "移除",
    t89: "打開所在的文件夾",
  ...
  ru_RU: {
    t1: "Приветствуем в NarwhalSlicer!",
    t2: "Для настройки NarwhalSlicer необходимо пройти несколько этапов. Давайте начнём!",
    ...
    t65: "Имейте в виду, что эти плагины не разрабатываются и не поддерживаются NarwhalSlicer. Используйте их на свой страх и риск.",
    ...
    t83: "2, Закройте все окна NarwhalSlicer",
    t84: "3, Удалите все файлы в папке плагина",
    t85: "4, Откройте NarwhalSlicer и снова установите плагин.",
    t86: "Закрыть",
    t87: "Инструкции",
    t88: "Удалить",
  ...
  ko_KR: {
    t1: "NarwhalSlicer에 오신 것을 환영합니다",
    t2: "NarwhalSlicer는 여러 단계로 설정됩니다. 시작!",
    t3: "사용자 약관",
    t4: "거부",
    t5: "동의",
    ...
    t83: "2, 열려 있는 모든 NarwhalSlicer를 닫습니다.",
    t84: "3, 플러그인 디렉터리 아래의 모든 파일 삭제합니다",
    t85: "4, NarwhalSlicer를 다시 열고 플러그인을 다시 설치하세요.",
    t86: "닫기",
    t87: "사용자 메뉴얼",
    t88: "제거",
    t89: "포함된 폴더 열기",
  ...
  tr_TR: {
    t1: "NarwhalSlicer'a hoş geldiniz",
    ...
    t65: "Lütfen bu eklentilerin NarwhalSlicer tarafından geliştirilmediğini veya bakımının yapılmadığını unutmayın. Kendi takdirinize ve riskinize göre kullanılmalıdırlar.",
    ...
    t85: "4, NarwhalSlicer'ı yeniden açın ve eklentiyi tekrar yükleyin",
    t86: "Kapat",
  ...
  pl_PL: {
    t1: "Witamy w NarwhalSlicer",
    t2: "NarwhalSlicer zostanie skonfigurowany w kilku krokach. Zacznijmy!",
    ...
    t65: "Proszę mieć świadomość, że te wtyczki nie są rozwijane ani utrzymywane przez NarwhalSlicer. Powinny być używane na własne ryzyko i z rozwagą.",
    ...
    t83: "2, Zamknij wszystkie otwarte NarwhalSlicer",
    t84: "3, Usuń wszystkie pliki z katalogu wtyczek",
    t85: "4, Ponownie otwórz NarwhalSlicer i zainstaluj wtyczkę ponownie",
    t86: "Zamknij",
  ...
  pt_BR: {
    t1: "Bem-vindo ao NarwhalSlicer",
    t2: "NarwhalSlicer será configurado em várias etapas. Vamos começar!",
    t3: "Termos de Uso",
    t4: "Discordo",
    t5: "Concordo",
    ...
    t65: "Por favor seja cuidadoso estes plugins não são desenvolvidos ou mantidos por NarwhalSlicer. Eles devem ser usados por sua conta e risco.",
    ...
    t83: "2, Feche totalmente o NarwhalSlicer",
    t84: "3, Delete todos os arquivos na pasta do plug-in",
    t85: "4, Reabra o NarwhalSlicer e instale o plug-in novamente",
    t86: "Fechar",
  ...
  lt_LT: {
    t1: "Pasisveikinkite su NarwhalSlicer",
    t2: "NarwhalSlicer bus nustatyta per kelis žingsnius. Pradėkime!",
    ...
    t65: "Atkreipkite dėmesį, kad NarwhalSlicer šių papildinių nesukuria ir neprižiūri. Juos turėtumėte naudoti savo nuožiūra ir rizika.",
    ...
    t83: "2, Uždarykite visas veikiančias NarwhalSlicer programas",
    t84: "3, Ištrinkite visus failus iš papildinių katalogo",
    t85: "4, Iš naujo atverkite NarwhalSlicer ir iš naujo įdiekite papildinį",
    t86: "Užverti",
