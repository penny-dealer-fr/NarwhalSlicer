...
#define SLIC3R_APP_FULL_NAME "NarwhalSlicer"
#define GCODEVIEWER_APP_NAME "NarwhalSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "OrcaSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("NarwhalSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
